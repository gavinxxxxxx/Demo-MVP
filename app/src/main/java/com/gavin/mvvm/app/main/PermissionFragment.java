...
import com.gavin.mvvm.app.news.TodayNewsFragment;
import com.gavin.mvvm.app.news.TodayNewsFragment2;
import com.gavin.mvvm.base.BundleKey;
import com.gavin.mvvm.base.RequestCode;
import com.gavin.mvvm.databinding.FragPermissionBinding;
import com.gavin.mvvm.utils.SPUtil2;
 ...
 */
public class PermissionFragment extends BindingFragment<FragPermissionBinding> {
    ...
    private void initView() {
        if (SPUtil2.getBoolean(_mActivity, BundleKey.IS_OPEN_AGAIN)) {
            checkPermission();
        } else {
            SPUtil2.saveBoolean(_mActivity, BundleKey.IS_OPEN_AGAIN, true);
    ...
    private void enterStatusEnable() {
        ...
        SPUtil2.saveBoolean(_mActivity, BundleKey.ENTER_STATUS_ENABLE, location[1] < 2);
    }
    ...
    private void checkPermission() {
        if (!(ContextCompat.checkSelfPermission(_mActivity, Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED)
            ...
            // TODO: 2016/12/28
//            start(TodayNewsFragment.newInstance());
            start(TodayNewsFragment2.newInstance());
        }
    }
